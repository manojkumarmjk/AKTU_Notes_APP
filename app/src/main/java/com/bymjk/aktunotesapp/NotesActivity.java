...
public class NotesActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.Database){
            ...
            intent.putExtra("filename","https://aktunotesapp.files.wordpress.com/2021/11/dbms-updated.pdf");
            startActivity(intent);
        }
        else if(view.getId() == R.id.compiler){
            Intent intent = new Intent(getApplicationContext(),Notes_webActivity.class);
            intent.putExtra("filename","https://aktunotesapp.files.wordpress.com/2021/11/compiler-design-updated.pdf");
            startActivity(intent);
        }
        else if(view.getId() == R.id.algo){
            Intent intent = new Intent(getApplicationContext(),Notes_webActivity.class);
            intent.putExtra("filename","https://aktunotesapp.files.wordpress.com/2021/11/daa_teacher_notes.pdf");
            startActivity(intent);
        }
        else if(view.getId() == R.id.computer_graphics){
            Intent intent = new Intent(getApplicationContext(),Notes_webActivity.class);
            intent.putExtra("filename","https://aktunotesapp.files.wordpress.com/2021/11/cg-unit-1_notes_compressed.pdf");
            startActivity(intent);
        }
        else if(view.getId() == R.id.human_computer_Interface){
            Intent intent = new Intent(getApplicationContext(),Notes_webActivity.class);
            intent.putExtra("filename","https://aktunotesapp.files.wordpress.com/2021/11/hci.pdf");
            startActivity(intent);
        }
    }
}