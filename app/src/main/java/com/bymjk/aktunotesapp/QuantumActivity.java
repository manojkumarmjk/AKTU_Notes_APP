...
public class QuantumActivity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.Database){
            ...
            intent.putExtra("filename","https://aktunotesapp.files.wordpress.com/2021/11/dbms-quantum.pdf");
            startActivity(intent);
        }
        else if(view.getId() == R.id.compiler){
            Intent intent = new Intent(getApplicationContext(),Notes_webActivity.class);
            intent.putExtra("filename","https://aktunotesapp.files.wordpress.com/2021/11/compiler-design-quantum.pdf");
            startActivity(intent);
        }
        else if(view.getId() == R.id.algo){
            Intent intent = new Intent(getApplicationContext(),Notes_webActivity.class);
            intent.putExtra("filename","https://aktunotesapp.files.wordpress.com/2021/11/daa-quantum.pdf");
            startActivity(intent);
        }
        else if(view.getId() == R.id.computer_graphics){
            Intent intent = new Intent(getApplicationContext(),Notes_webActivity.class);
            intent.putExtra("filename","https://aktunotesapp.files.wordpress.com/2021/11/cg-quantum.pdf");
            startActivity(intent);
        }
        else if(view.getId() == R.id.human_computer_Interface){
            Intent intent = new Intent(getApplicationContext(),Notes_webActivity.class);
            intent.putExtra("filename","https://aktunotesapp.files.wordpress.com/2021/11/hci-quantum.pdf");
            startActivity(intent);
        }
    }
}